            ...
            steps {
                ...
                script {
                    ...
                    if(artifactExists) {
                        ...
                        nexusArtifactUploader (artifacts: [[artifactId: 'spring-boot-restcontroller-example', classifier:'', file: '/var/lib/jenkins/workspace/springpipe/spring-boot-restcontroller-example-0.0.1-SNAPSHOT.jar', type: 'jar']], groupId: 'es.macero.dev', nexusUrl: 'localhost:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'deployments', version: '0.0.1-SNAPSHOT'
                       );
